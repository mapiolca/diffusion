...
/**
 * \file       htdocs/core/modules/diffusion/mod_diffusion_advanced.php
 * \ingroup    diffusion
...
class mod_diffusion_advanced extends ModeleNumRefDiffusion
{
	...
	public function info($langs)
	{
		...
		$text .= '<input type="hidden" name="maskconst" value="DIFFUSION_MYOBJECT_ADVANCED_MASK">';
		...
		$text .= '<td class="right">'.$form->textwithpicto('<input type="text" class="flat minwidth175" name="maskvalue" value="'.getDolGlobalString('DIFFUSION_MYOBJECT_ADVANCED_MASK').'">', $tooltip, 1, 1).'</td>';
	...
	public function getNextValue($object)
	{
		...
		// We get cursor rule
		$mask = getDolGlobalString('DIFFUSION_MYOBJECT_ADVANCED_MASK');
