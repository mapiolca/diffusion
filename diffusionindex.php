...
/**
 *	\file       diffusion/diffusionindex.php
 *	\ingroup    diffusion
 *	\brief      Home page of diffusion top menu
 */
...
//}
//if (! $user->hasRight('diffusion', 'myobject', 'read')) {
//	accessforbidden();
//}
//restrictedArea($user, 'diffusion', 0, 'diffusion_myobject', 'myobject', '', 'rowid');
//if (empty($user->admin)) {
...
llxHeader("", $langs->trans("DiffusionArea"), '', '', 0, 0, '', '', '', 'mod-diffusion page-index');

print load_fiche_titre($langs->trans("DiffusionArea"), '', 'diffusion.png@diffusion');
