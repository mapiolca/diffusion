...
$permissiontoadd = (!empty($user->admin) || $user->hasRight('diffusion', 'diffusiondoc', 'write') || $user->hasRight('diffusion', 'diffusion', 'write') || $user->hasRight('diffusion', 'write')); // Used by the include of actions_addupdatedelete.inc.php and actions_lineupdown.inc.php
$permissiontodelete = ((!empty($user->admin) || $user->hasRight('diffusion', 'diffusiondoc', 'delete') || $user->hasRight('diffusion', 'diffusion', 'delete') || $user->hasRight('diffusion', 'delete'))) || ($permissiontoadd && isset($object->status) && $object->status == $object::STATUS_DRAFT);
