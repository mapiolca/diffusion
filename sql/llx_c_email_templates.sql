...
INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, active, enabled, joinfiles, topic, content)
SELECT 1, 'diffusion', 'diffusiondoc@diffusion', 'fr_FR', 0, NULL, NOW(), 'Notification diffusion', 110, 1, 'isModEnabled("diffusion")', '0',
...
WHERE NOT EXISTS (
	SELECT 1 FROM llx_c_email_templates
	WHERE entity = 1 AND module = 'diffusion' AND type_template = 'diffusiondoc@diffusion' AND lang = 'fr_FR' AND label = 'Notification diffusion'
);

INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, active, enabled, joinfiles, topic, content)
SELECT 1, 'diffusion', 'diffusiondoc@diffusion', 'en_US', 0, NULL, NOW(), 'Diffusion notification', 110, 1, 'isModEnabled("diffusion")', '0',
...
WHERE NOT EXISTS (
	SELECT 1 FROM llx_c_email_templates
	WHERE entity = 1 AND module = 'diffusion' AND type_template = 'diffusiondoc@diffusion' AND lang = 'en_US' AND label = 'Diffusion notification'
);

INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, active, enabled, joinfiles, topic, content)
SELECT 1, 'diffusion', 'diffusioncontact@diffusion', 'fr_FR', 0, NULL, NOW(), 'Notification contact de diffusion', 120, 1, 'isModEnabled("diffusion")', '0',
...
WHERE NOT EXISTS (
	SELECT 1 FROM llx_c_email_templates
	WHERE entity = 1 AND module = 'diffusion' AND type_template = 'diffusioncontact@diffusion' AND lang = 'fr_FR' AND label = 'Notification contact de diffusion'
);

INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, active, enabled, joinfiles, topic, content)
SELECT 1, 'diffusion', 'diffusioncontact@diffusion', 'en_US', 0, NULL, NOW(), 'Diffusion contact notification', 120, 1, 'isModEnabled("diffusion")', '0',
...
WHERE NOT EXISTS (
	SELECT 1 FROM llx_c_email_templates
	WHERE entity = 1 AND module = 'diffusion' AND type_template = 'diffusioncontact@diffusion' AND lang = 'en_US' AND label = 'Diffusion contact notification'
);
