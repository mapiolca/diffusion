...
$id = GETPOSTINT('id');
$element = GETPOST('element', 'none');	// 'myobject' (myobject=mymodule) or 'myobject@mymodule' or 'myobject_mysubobject' (myobject=mymodule)
$element = preg_replace('/[^a-zA-Z0-9_@]/', '', (string) $element);
...
if (preg_match('/^diffusioncontact(@diffusion)?$/', $element)) {
